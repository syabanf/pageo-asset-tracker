/* Converted from mobile/muster.html (state: Offline muster) */
// converted
PN.page("muster-offline", {
  title: "Muster — Offline muster",
  icon: "flag",
  nav: "none",
  time: "15:38",
  offline: true,
  ...
  render() {
    return `<div class="m-banner crit"><i data-icon="siren"></i>Emergency muster · MV Pageo 02<span class="right">15:38</span></div>
        <div class="m-banner offline"><i data-icon="wifioff"></i>Offline · confirmation will sync when connected</div>
        <div class="m-body center" style="padding-top:20px">
          ...
          <div class="grow"></div>
          <a class="m-btn success lg" href="muster-confirmed.html" style="font-size:19px;letter-spacing:.04em"><i data-icon="check" class="ic-24"></i>I'M SAFE (will sync)</a>
